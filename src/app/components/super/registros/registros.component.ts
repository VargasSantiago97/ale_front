...
export class RegistrosComponent {
  ...
  ngOnInit() {
      ...
      this.colsProd = [
        ...
        { field: 'establecimiento', header: 'GRANO' },
        { field: 'establecimiento', header: 'DESDE' },
          { field: 'has', header: 'PRODUCE' },
          { field: 'cant_mov', header: 'RETIRA' },
          { field: 'cant_trilla', header: 'ENTREGA' },
          { field: 'kg_trilla', header: 'EXPORTADOR' },
          { field: 'kg_silo', header: 'CORREDOR' },
          { field: 'cant_silo', header: 'DESTINO' },
          { field: 'cant_silo', header: 'KG BRUTO' },
          { field: 'cant_silo', header: 'KG TARA' },
          { field: 'cant_silo', header: 'KG NETO' },
          { field: 'cant_silo', header: 'REGUACION' },
          { field: 'cant_silo', header: 'KG SALIDA' },
          { field: 'cant_silo', header: 'KG CAMPO' },
          { field: 'cant_silo', header: 'ACOND.' },
          { field: 'cant_silo', header: 'KG DESTINO' },
          { field: 'cant_silo', header: 'KG MERMAS' },
          { field: 'cant_silo', header: 'KG FINAL' },
      ]
